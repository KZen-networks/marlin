...
impl<F: PrimeField> AHPForR1CS<F> {
    ...
    pub fn verifier_query_set<'a, 'b, R: RngCore, C: ConstraintSynthesizer<F>>(
        ...
        query_set.insert(("a_row".to_string(), beta_3));
        query_set.insert(("a_col".to_string(), beta_3));
        query_set.insert(("a_val".to_string(), beta_3));
        query_set.insert(("b_row".to_string(), beta_3));
        query_set.insert(("b_col".to_string(), beta_3));
        query_set.insert(("b_val".to_string(), beta_3));
        query_set.insert(("c_row".to_string(), beta_3));
        query_set.insert(("c_col".to_string(), beta_3));
        query_set.insert(("c_val".to_string(), beta_3));

        query_set.insert(("w".to_string(), beta_1));
        query_set.insert(("z_a".to_string(), beta_1));
        query_set.insert(("z_b".to_string(), beta_1));
        query_set.insert(("mask_poly".to_string(), beta_1));
        query_set.insert(("g_1".to_string(), beta_1));
        query_set.insert(("h_1".to_string(), beta_1));

        query_set.insert(("g_2".to_string(), beta_2));
        query_set.insert(("h_2".to_string(), beta_2));

        query_set.insert(("g_3".to_string(), beta_3));
        query_set.insert(("h_3".to_string(), beta_3));
    ...
    pub fn verifier_decision<C: ConstraintSynthesizer<F>>(
        ...
        let a_row_at_beta_3 = *evals.get(&("a_row".to_string(), beta_3)).ok_or(Error::MissingEval("a_row"))?;
        let a_col_at_beta_3 = *evals.get(&("a_col".to_string(), beta_3)).ok_or(Error::MissingEval("a_col"))?;
        let a_val_at_beta_3 = *evals.get(&("a_val".to_string(), beta_3)).ok_or(Error::MissingEval("a_val"))?;
        let b_row_at_beta_3 = *evals.get(&("b_row".to_string(), beta_3)).ok_or(Error::MissingEval("b_row"))?;
        let b_col_at_beta_3 = *evals.get(&("b_col".to_string(), beta_3)).ok_or(Error::MissingEval("b_col"))?;
        let b_val_at_beta_3 = *evals.get(&("b_val".to_string(), beta_3)).ok_or(Error::MissingEval("b_val"))?;
        let c_row_at_beta_3 = *evals.get(&("c_row".to_string(), beta_3)).ok_or(Error::MissingEval("c_row"))?;
        let c_col_at_beta_3 = *evals.get(&("c_col".to_string(), beta_3)).ok_or(Error::MissingEval("c_col"))?;
        let c_val_at_beta_3 = *evals.get(&("c_val".to_string(), beta_3)).ok_or(Error::MissingEval("c_val"))?;
        ...
        let h_3_at_beta_3 = *evals.get(&("h_3".to_string(), beta_3)).ok_or(Error::MissingEval("h_3"))?;
        let g_3_at_beta_3 = *evals.get(&("g_3".to_string(), beta_3)).ok_or(Error::MissingEval("g_3"))?;
        ...
        let g_2_at_beta_2 = *evals.get(&("g_2".to_string(), beta_2)).ok_or(Error::MissingEval("g_2"))?;
        let h_2_at_beta_2 = *evals.get(&("h_2".to_string(), beta_2)).ok_or(Error::MissingEval("h_2"))?;
        ...
        let mask_poly_at_beta_1 = *evals.get(&("mask_poly".to_string(), beta_1)).ok_or(Error::MissingEval("mask_poly"))?;
        let r_alpha_at_beta_1 = domain_h.eval_unnormalized_bivariate_lagrange_poly(alpha, beta_1);

        let z_a_at_beta_1 = *evals.get(&("z_a".to_string(), beta_1)).ok_or(Error::MissingEval("z_a"))?;
        let z_b_at_beta_1 = *evals.get(&("z_b".to_string(), beta_1)).ok_or(Error::MissingEval("z_b"))?;
        ...
        let x_poly_at_beta_1 = x_domain
            ...
            .map(|(l, x)| l * &x)
            .fold(F::zero(), |x, y| x + &y);
        let w_at_beta_1 = *evals.get(&("w".to_string(), beta_1)).ok_or(Error::MissingEval("w"))?;
        let z_at_beta_1 = w_at_beta_1 * &x_domain.evaluate_vanishing_polynomial(beta_1) + &x_poly_at_beta_1;

        let g_1_at_beta_1 = *evals.get(&("g_1".to_string(), beta_1)).ok_or(Error::MissingEval("g_1"))?;
        let h_1_at_beta_1 = *evals.get(&("h_1".to_string(), beta_1)).ok_or(Error::MissingEval("h_1"))?;
